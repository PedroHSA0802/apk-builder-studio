...
<p align="center"> <img src="docs/screens-overview.png" alt="Overview of all four APK Builder Studio screens" width="100%"> </p> <p align="center"> <img src="docs/samai.png" alt="SamAI - the integrated debugging assistant" width="100%"> </p>

APK Builder Studio sets up the entire Android build environment for you — WSL, Buildozer, the Android SDK/NDK — and walks you through project setup, native modules, builds and on-device debugging with just a few clicks. When something breaks, the built-in assistant SamAI reads your build log or logcat and writes the fix straight into your project files.
